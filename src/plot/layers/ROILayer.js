...
export class ROILayer extends CompositeLayer {
  ...
  _buildLineROILayers(roi, coords) {
    const { toX, toY, deckXMin, deckXMax, deckYMin, deckYMax } = coords;
    ...
    if (roi.orientation === 'vertical') {
      ...
      switch (roi.mode) {
        ...
        default:                  path = [[lx, deckYMin, 0], [lx, deckYMax, 0]];
      }
    } else {
      ...
      switch (roi.mode) {
        ...
        default:                 path = [[deckXMin, ly, 0], [deckXMax, ly, 0]];
      }
    }
