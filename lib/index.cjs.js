...
var fftWindowing = require('fft-windowing');
...
var fftWindowing__namespace = /*#__PURE__*/_interopNamespaceDefault(fftWindowing);
...
class DataStore extends EventEmitter.EventEmitter {
...
class ViewportController extends EventEmitter.EventEmitter {
  /**
   * @param {object} opts
...
const formatSci = d3Format.format('.3~s');
const formatFixed = d3Format.format('.4~g');
...
const defaultTimeFormat = d3Scale.scaleTime().tickFormat();
...
const fmtDate = d3TimeFormat.timeFormat('%Y-%m-%d');
const fmtHour = d3TimeFormat.timeFormat('%m-%d %H:%M');
const fmtMinute = d3TimeFormat.timeFormat('%H:%M');
const fmtSecond = d3TimeFormat.timeFormat('%H:%M:%S');
...
let _nextId = 1;
class ROIBase extends EventEmitter.EventEmitter {
  /**
   * @param {object} opts
...
class ROIController extends EventEmitter.EventEmitter {
  /**
   * @param {ViewportController} viewport
   */
...
class ROILayer extends core.CompositeLayer {
  ...
  _buildLinearRegionLayers(roi, coords) {
    ...
    const fillLayer = new layers.PolygonLayer({
      id: `${roi.id}-fill`,
      data: [{
        polygon
      }],
    ...
    const edgeLayer = new layers.PathLayer({
      id: `${roi.id}-edges`,
      data: [{
  ...
  _buildLineROILayers(roi, coords) {
    ...
    const layers$1 = [];
    layers$1.push(new layers.PathLayer({
      id: `${roi.id}-line`,
      data: [{
        path
      }],
    ...
    if (roi.selected) {
      ...
      layers$1.push(new layers.ScatterplotLayer({
        id: `${roi.id}-handle`,
        data: [{
          position: handlePos
        }],
  ...
  _buildRectROILayers(roi, coords) {
    ...
    const layers$1 = [];
    layers$1.push(new layers.PolygonLayer({
      id: `${roi.id}-fill`,
      data: [{
        polygon
      }],
 ...
 */
class PlotLayer extends core.CompositeLayer {
  static get layerName() {
    return 'PlotLayer';
  }
  renderLayers() {
...
class PlotController extends EventEmitter.EventEmitter {
  /**
   * @param {object} opts
  ...
  init(webglCanvas, axisCanvas) {
    ...
    // Initialize deck.gl
    this._deck = new core.Deck({
      canvas: webglCanvas,
      width: w,
      height: h,
      views: [new core.OrthographicView({
        id: 'ortho',
        controller: false,
        flipY: false
      })],
...
class PlotDataView extends EventEmitter.EventEmitter {
  /**
...
class LUTHistogramController {
  ...
  constructor({
    ...
    this._plotController.registerDataLayer('histogram-bars', ctx => {
      ...
      return new layers.SolidPolygonLayer({
        id: 'histogram-bars',
        data: this._barData,
        getPolygon: d => d.polygon,
...
class BitmapDataLayer extends core.CompositeLayer {
  initializeState() {
  ...
  renderLayers() {
    ...
    return [new layers.BitmapLayer(this.getSubLayerProps({
      id: 'bitmap',
      image,
      bounds,
      updateTriggers: {
...
class BitmapViewGenerator extends EventEmitter.EventEmitter {
  /**
...
class LUTController extends EventEmitter {
  /**
...
class AudioController extends EventEmitter {
  ...
  _computeTileSTFT(samples, windowSize, hopSize, windowFn) {
    ...
    for (let f = 0; f < numFrames; f++) {
      ...
      if (windowFn !== 'rectangular' && typeof fftWindowing__namespace[windowFn] === 'function') {
        fftWindowing__namespace[windowFn](frame); // mutates frame in-place
      }
 ...
 */
class PopupWindowManager extends EventEmitter.EventEmitter {
  constructor() {
    super();
    /** @type {Window|null} */
    this._popup = null;
...
const PlotCanvas = /*#__PURE__*/react.forwardRef(function PlotCanvas(props, ref) {
  const {
    width = '100%',
    height = '100%',
    xScaleType = 'linear',
...
exports.BitmapDataLayer = BitmapDataLayer;
exports.BitmapViewGenerator = BitmapViewGenerator;
exports.ConstraintEngine = ConstraintEngine;
exports.DataStore = DataStore;
exports.ExternalDataAdapter = ExternalDataAdapter;
exports.ExternalROIAdapter = ExternalROIAdapter;
exports.FilterController = FilterController;
exports.LUTController = LUTController;
exports.LUTHistogramController = LUTHistogramController;
exports.LineROI = LineROI;
exports.LinearRegion = LinearRegion;
exports.MockDataAdapter = MockDataAdapter;
exports.MockROIAdapter = MockROIAdapter;
exports.PlaybackController = PlaybackController;
exports.PlotCanvas = PlotCanvas;
exports.PlotController = PlotController;
exports.PlotDataView = PlotDataView;
exports.PlotLayer = PlotLayer;
exports.PopupWindowManager = PopupWindowManager;
exports.ROIBase = ROIBase;
exports.ROIController = ROIController;
exports.ROILayer = ROILayer;
exports.RectROI = RectROI;
exports.SignalStore = SignalStore;
exports.TraceGroup = TraceGroup;
exports.ViewportController = ViewportController;
exports.buildEpochTickFormatter = buildEpochTickFormatter;
exports.buildLineLayer = buildLineLayer;
exports.buildScatterLayer = buildScatterLayer;
exports.buildSignalLayers = buildSignalLayers;
exports.dataXToEpochSeconds = dataXToEpochSeconds;
exports.epochSecondsToDataX = epochSecondsToDataX;
exports.usePopupChannel = usePopupChannel;
