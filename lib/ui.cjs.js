...
var FilterController_js = require('../src/audio/FilterController.js');
var LUTController_js = require('../src/plot/layers/LUTController.js');
...
function FilterPanel({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, FilterController_js.FilterController.filterTypes.map(t => /*#__PURE__*/React.createElement("option", {
    key: t,
    value: t
  }, t))), isSingleCutoff && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      alignItems: 'center',
  ...
  }, "Order "), [2, 4, 6, 8].map(n => /*#__PURE__*/React.createElement("label", {
    key: n,
    style: {
      marginRight: 4,
      cursor: 'pointer'
  ...
  }, state.type === 'lowpass' ? 'Cutoff (low) ' : 'Cutoff (high) '), /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#aaa'
    }
  }, state.frequency < 1000 ? `${state.frequency.toFixed(0)} Hz` : `${(state.frequency / 1000).toFixed(2)} kHz`), /*#__PURE__*/React.createElement("input", {
    type: "range",
    min: "0",
    max: "1",
    step: "0.001",
  ...
  }, state.Q.toFixed(2)), /*#__PURE__*/React.createElement("input", {
    type: "range",
    min: "0.1",
    max: "30",
    step: "0.1",
    ...
    style: sliderStyle
  }))), isBandType && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("label", null, /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#555'
    }
  }, "Low freq "), /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#aaa'
    }
  }, state.lowFreq < 1000 ? `${state.lowFreq.toFixed(0)} Hz` : `${(state.lowFreq / 1000).toFixed(2)} kHz`), /*#__PURE__*/React.createElement("input", {
    type: "range",
    min: "0",
    max: "1",
    step: "0.001",
  ...
  }, "High freq "), /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#aaa'
    }
  }, state.highFreq < 1000 ? `${state.highFreq.toFixed(0)} Hz` : `${(state.highFreq / 1000).toFixed(2)} kHz`), /*#__PURE__*/React.createElement("input", {
    type: "range",
    min: "0",
    max: "1",
    step: "0.001",
  ...
  }, "center ", state.frequency < 1000 ? `${state.frequency.toFixed(0)} Hz` : `${(state.frequency / 1000).toFixed(2)} kHz`, ' · ', "Q ", state.Q.toFixed(2))), /*#__PURE__*/React.createElement("canvas", {
    ref: canvasRef,
    width: 118,
    height: 55,
    style: {
...
function LUTPanel({
  ...
  const gradCanvasRef = react.useRef(null);
  const [preset, setPreset] = react.useState(() => lutController.state.lutName);
  ...
  }, LUTController_js.LUTController.presetNames.map(n => /*#__PURE__*/React.createElement("option", {
    key: n,
    value: n
...
function HelpOverlay({
  ...
  }, /*#__PURE__*/React.createElement("tbody", null, controls.map(({
    key,
    description
